...
public class MainNew {
    ...
    public static void main(String[] args) {
        ...
        //total investido no dia 31/05/2022
        double investimentos10[] = {87258.07, 84198.28, 22773.27, 443.55, 7763.72, 4210.01, 1221.11, 350.01};

        //total investido no dia 06/06/2022
        double investimentos11[] = {210697.01};
